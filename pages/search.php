...
<div class="container mx-auto px-4 py-12">
    <h1 class="text-4xl font-bold mb-8">Search Lost & Found Items</h1>
        ...
        <form method="GET" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="category" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-600">
                ...
                <div>
                    ...
                    <select name="item_type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-600">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo BASE_URL; ?>pages/search.php" class="bg-gray-400 text-white px-6 py-2 rounded-lg hover:bg-gray-500 font-semibold">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition transform hover:-translate-y-1">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span class="<?php echo $item_data['item_type'] == 'lost' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'; ?> px-3 py-1 rounded text-xs font-bold">
                        ...
                        <div class="space-y-2 text-sm text-gray-600 mb-4">
                            <p><i class="fas fa-tag text-blue-600"></i> <?php echo escape($item_data['category']); ?></p>
                            <p><i class="fas fa-map-marker-alt text-red-600"></i> <?php echo escape($item_data['location']); ?></p>
                            <p><i class="fas fa-calendar text-green-600"></i> <?php echo formatDate($item_data['date_lost_found']); ?></p>
                            <p><i class="fas fa-clock text-gray-600"></i> <?php echo getRelativeTime($item_data['date_posted']); ?></p>
                        </div>
                        ...
                        <div class="flex items-center mb-4 p-2 bg-gray-50 rounded">
                            ...
                            <?php else: ?>
                                <div class="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center mr-2 text-xs font-bold">
                                    <?php echo strtoupper(substr($item_data['username'], 0, 1)); ?>
                                </div>
                            <?php endif; ?>
                            <span class="text-sm font-semibold"><?php echo escape($item_data['username']); ?></span>
                        </div>
        ...
        <?php else: ?>
            <div class="col-span-full bg-gray-100 rounded-lg p-12 text-center">
                ...
                <a href="<?php echo BASE_URL; ?>pages/search.php" class="inline-block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">
                    Clear Filters
                </a>
            </div>
        <?php endif; ?>
